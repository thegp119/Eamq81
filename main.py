...
print(f"📋 BOT_TOKEN set: {bool(BOT_TOKEN)} (length: {len(BOT_TOKEN) if BOT_TOKEN else 0})")
print(f"📋 STRIPE_API_KEY set: {bool(STRIPE_API_KEY)} (length: {len(STRIPE_API_KEY) if STRIPE_API_KEY else 0})")

# Clean up BOT_TOKEN - strip whitespace
if BOT_TOKEN:
