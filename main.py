...
async def on_message(message: discord.Message):
    ...
    if message.channel.name.startswith("ticket-") and "ubereats.com" in message.content:
        ubereats_link = None
    ...
    # Don't manually process commands - let discord.py decorators handle it automatically
